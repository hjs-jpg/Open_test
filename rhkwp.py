...
class Calculator(QWidget): #Calculator 클래스를 QWidget을 상속받아 정의
    ...
    def initUI(self):   #UI를 초기화하는 함수
        ...
        vbox = QVBoxLayout()
        vbox.addWidget(self.te1)#텍스트 입력 창과 버튼 레이아웃을 추가
        ...
        self.setWindowIcon(QIcon('icon.png'))#윈도우 아이콘 설정(아이콘 파일 필요)
...
if __name__ == '__main__':
    ...
    sys.exit(app.exec_())#애플리케이션 실행, 종료 시 시스템 종료합니
